...
export const workExperienceList: WorkExperience[] = [
  {
    jobDesk: "Staff IT",
    companyName: "Bank BNI Mattoangin Makassar",
    years: "January - July 2021",
    jobStatus: "Internship",
    jobDescription: "● Create a web-based customer credit application using the codeigniter framework. ●Organize and secure data. ●Troubleshoot Hardware & Software. ●Troubleshoot Networking. ●Reinstall employee's computer. ●Problem Solving.",
    techStack: ["/assets/svg/html.svg", "/assets/svg/php.svg", "/assets/svg/css.svg", "/assets/svg/javascript.svg", "/assets/svg/codeigniter.svg", "/assets/svg/lan-network.svg", "/assets/svg/wan.svg", "/assets/svg/MikroTik.svg"],
  },
  {
    jobDesk: "Staff IT",
    companyName: "Kominfo Makassar",
    years: "December 2021 - January 2023",
    jobStatus: "Full-Time",
