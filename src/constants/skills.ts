...
export const skillList: Skill[] = [
  ...
  {
    skillIcon: "/assets/svg/lan-network.svg",
    title: "LAN",
    level: "Intermediate",
    description: "Perform test, setup, installation, and configuration of Windows server operating systems, network system components, and cabling.",
  },
  {
    skillIcon: "/assets/svg/MikroTik.svg",
    title: "Mikrotik",
    level: "Intermediate",
    description: "Routing dan Swithching",
  },
  {
    skillIcon: "/assets/svg/wan.svg",
    title: "WAN",
    level: "Intermediate",
    description: "Work on different networking concepts and routing protocols like OSPF and other LAN WAN technologies.",
  },
];
