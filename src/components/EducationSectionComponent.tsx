...
import { CertificateListItem, EducationListItem, SectionDescription, SectionSubtitle, SectionTitle } from "@/fragments";
import { CertificateList, educationList } from "@/constants";
        ...
        >
          ...
          >
            <Flex
              ...
              rowGap={{ base: 3, lg: 5 }}
            >
              <SectionSubtitle>Educations🎓 & Certificates</SectionSubtitle>

              <SectionDescription>There are some formal educations & certificates that I&apos;ve reached below</SectionDescription>
            </Flex>
          </GridItem>

          {/* Education Section Educations & Certficate Content */}
          <GridItem
          ...
          >
            ...
            >
              ...
              {/* Education Section Certificate Content */}
              <GridItem
                as={motion.div}
                variants={fadeInTransition("left", "tween", 0.2, 1.1)}
              >
                ...
                <Box marginTop={8}>
                  {CertificateList.map(
                    ({ certificate, place, years }, index): React.ReactNode => (
                      <CertificateListItem
                        key={`${place} - ${index}`}
